...
public class ServiceSOMResponseProjection extends GraphQLResponseProjection {
    ...
    public ServiceSOMResponseProjection all$(int maxDepth) {
        ...
        if (projectionDepthOnFields.getOrDefault("ServiceSOMResponseProjection.ServiceSOMResponseProjection.composedof", 0) <= maxDepth) {
            ...
            this.supportingService(new SupportingServiceResponseProjection().all$(maxDepth - projectionDepthOnFields.getOrDefault("ServiceSOMResponseProjection.ServiceSOMResponseProjection.composedof", 0)));
        }
    ...
    public ServiceSOMResponseProjection supportingService(SupportingServiceResponseProjection subProjection) {
        return supportingService(null, subProjection);
    }

    public ServiceSOMResponseProjection supportingService(String alias, SupportingServiceResponseProjection subProjection) {
